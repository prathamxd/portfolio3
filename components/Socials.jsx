  ...
  return (
    <div className="md:px-36 px-7 my-20 md:my-36">
      ...
      <div className="h-32 flex flex-col md:flex-row md:gap-10 gap-6">
        <div className="border-t-[1px] border-gray-600 bg-[#1A1A1A] hover:bg-[#1F1F1F] transition-colors duration-300 rounded-2xl py-7 md:py-0 md:w-[60%] flex justify-between px-5 md:px-10 items-center">
        ...
        <a
          ...
          target="_blank"
          className="border-t-[1px] border-gray-600 bg-[#1A1A1A] hover:bg-[#1F1F1F] transition-colors duration-300 rounded-2xl w-full md:w-[12.5%] py-8 md:py-0 flex items-center justify-center"
        >
