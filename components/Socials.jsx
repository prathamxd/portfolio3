...
const Socials = () => {
  return (
    <div className="md:px-36 px-7 my-36">
      <h1 className="md:text-3xl font-bold mb-8">LET&apos;S WORK TOGETHER</h1>
      <div className="h-32 flex flex-col md:flex-row gap-10">
        <div className="border-t-[1px] border-gray-600 bg-[#1A1A1A] rounded-2xl py-7 md:py-0 md:w-[60%] flex justify-between px-8 items-center">
